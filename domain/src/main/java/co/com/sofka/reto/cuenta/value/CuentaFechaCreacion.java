...
public class CuentaFechaCreacion implements ValueObject<String> {
    private final LocalDate date;
    private final String format;

    public CuentaFechaCreacion(int day, int month, int year) {
        try {
    ...
    public boolean equals(Object o) {
        ...
        CuentaFechaCreacion that = (CuentaFechaCreacion) o;
